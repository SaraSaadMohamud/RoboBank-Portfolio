...
size_t Portfolio:: CountAccounts()
{
...
void Portfolio::ApplyFromLedger(const std::string* account_ids, const int* tx_types, const long long* amounts, int count)
{
...
long long Portfolio:: TotalExposure() const
{
    long long total = 0;
    Calculator calc;
